...
def main():
    ...
    train_data = load_data(args.cache_dir, use_pre_relu=args.pre_relu, data_file="train_data.pkl")
    ...
    n_features = train_data[0][act_key].shape[1]
    ...
    if train_token_only:
        ...
        rnn_token_predictor.fit(train_data, embed_matrix)
    ...
    if train_state_token:
        ...
        rnn_state_token_predictor.fit(train_data, embed_matrix)
